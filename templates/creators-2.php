			...
			<div class="bg-purple lg:min-h-[100vh]">
				<div class="container px-6 sm:px-7 md:px-8 lg:px-10 lg:px-12 2xl:px-16">
					<div
						...
						<div class="media lg:self-center flex flex-col items-center">
							<video preload="metadata" autoplay loop muted playsinline poster="<?php echo LY_ASSET_URI; ?>/images/creators-hero.webp" class="lg:max-h-[500px]">
					...
					<div class="wrap max-lg:py-12 h-full sticky top-0">
						...
						<div id="accordian" class="relative max-sm:max-w-[320px] m-auto h-full lg:grid lg:grid-cols-2">
							<div id="accodian-items" class="lg:py-[50vh] xl:pl-40">
								<div class="accordian-item mb-16 lg:mb-20 xl:mb-24 opacity-50" data-index="1">
									<div
								...
								<div class="accordian-item my-16 lg:my-20 xl:my-24 opacity-50" data-index="2">
									<div
										class="accoridan-content lg:pr-6 flex flex-col justify-center max-lg:items-center max-lg:pb-4">
										<h3 class="font-bold text-xl lg:text-2xl xl:text-3xl max-lg:text-center">
								...
								<div class="accordian-item mt-16 lg:mt-20 xl:mt-24 opacity-50" data-index="3">
									<div
										class="accoridan-content lg:pr-6 flex flex-col justify-center max-lg:items-center max-lg:pb-4">
										<h3 class="font-bold text-xl lg:text-2xl xl:text-3xl max-lg:text-center">
											Get Paid in Seconds
				...
				<div class="container px-6 sm:px-7 md:px-8 lg:px-10 lg:px-12 2xl:px-16">
					<div class="wrap py-12 lg:py-20 xl:py-24 flex flex-col items-center">
						...
						<div id="video" class="relative mb-12 lg:mb-24">
							<video poster="<?php echo LY_ASSET_URI; ?>/images/lolly-placeholder.svg"
								class="video rounded-2xl m-auto h-[200px] lg:h-[500px]" height="400" controls>
								<source src="<?php echo LY_ASSET_URI; ?>/videos/lolly-overview.mp4" type="video/mp4">
							</video>
							<div id="video-overlay"
								class="absolute h-full w-full top-0 bottom-0 left-0 right-0 bg-white rounded-2xl">
								<h1
									class="absolute ly-text top-[25%] left-[50%] -translate-x-1/2 -translate-y-1/2 text-xl font-black xl:text-6xl">
									Campaign
								</h1>
								<button
									class="absolute px-3 py lg:px-4 lg:py-2 border-solid border-2 border-black rounded-lg border ly-text top-[75%] left-[50%] -translate-x-1/2 -translate-y-1/2 font-medium">
							...
							<img id="ly-play"
								class="absolute ly-play w-[40px] lg:h-[100px] lg:w-[100px] top-[50%] left-[50%] -translate-x-1/2 -translate-y-1/2"
